...
def load_app():
    ...
    name = "w107_identity_" + uuid.uuid4().hex
...
@unittest.skipUnless(RUN and HAVE_GTK and display_ready(), "real W107 GTK identity lane")
class W107IdentityRealAppE2E(unittest.TestCase):
                ...
                try:
                    ...
                    def close_system_info():
                        ...
                        for token in (
                            ...
                            "Work item: W107",
                            "Work item description: Subsystem Host-Port Migration",
                    ...
                    print("W107_CURRENT_IDENTITY=PASS")
                finally:
                    window.destroy(); pump()
