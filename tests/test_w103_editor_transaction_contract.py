...
class W103EditorTransactionContractTests(unittest.TestCase):
    def test_identity_is_exact(self):
        ...
        self.assertIn('DEVELOPMENT_WORK_ITEM = "W108"', source)
        self.assertIn('DEVELOPMENT_WORK_ITEM_DESCRIPTION = "Thin GTK Shell"', source)
        self.assertIn('PUBLISHED_BASELINE = "e16cc21b8a900298406ae8cc4776f6f1ec658e93"', source)
