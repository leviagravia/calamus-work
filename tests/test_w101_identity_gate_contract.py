...
class W101IdentityGateContractTests(unittest.TestCase):
    ...
    def test_release_manifest_owns_current_profiles_and_historical_identity_is_not_release(self):
        ...
        self.assertTrue(data["profiles"]["w104-headless-focused"]["release_gate"])
        self.assertTrue(data["profiles"]["w104-command-action-smoke"]["release_gate"])
        self.assertFalse(data["profiles"]["w104-identity-smoke"]["release_gate"])
