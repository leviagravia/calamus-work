...
class SmartTypographyLayerWiringTests(unittest.TestCase):
    ...
    def test_dispatch_surface_adds_only_smart_typography(self):
        ...
        self.assertEqual(
            sorted(dispatch_ids),
            ["edit.lowercase", "edit.uppercase", "writing.clean-pdf", "writing.join-lines", "writing.reflow-paragraph", "writing.remove-extra-spaces", "writing.remove-trailing-spaces", "writing.smart-typography", "writing.statistics"],
        )
