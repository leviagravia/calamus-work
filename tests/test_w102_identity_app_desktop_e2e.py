...
def load_app():
    ...
    name = "w102_identity_" + uuid.uuid4().hex
...
@unittest.skipUnless(RUN and HAVE_GTK and display_ready(), "real W102 GTK identity lane")
class W102IdentityRealAppE2E(unittest.TestCase):
                ...
                try:
                    ...
                    def close_system_info():
                        ...
                        for token in (
                            ...
                            "Work item: W102",
                            "Work item description: Document Session Extraction",
                            "Published baseline: 17b409a05f356477173b2bdd348a67a4cf01f43c",
                        ):
                    ...
                    pump()
                    driver.assert_complete()
                    print("W102_CURRENT_IDENTITY=PASS")
                finally:
                    window.destroy()
                    pump()
