...
def load_app():
    ...
    name = "w101_identity_" + uuid.uuid4().hex
...
@unittest.skipUnless(RUN and HAVE_GTK and display_ready(), "real W101 GTK identity lane")
class W101IdentityRealAppE2E(unittest.TestCase):
            ...
            try:
                ...
                def close_system_info():
                    ...
                    for token in (
                        ...
                        "Work item: W101",
                        "Work item description: Core Composition Boundary and Dependency Enforcement",
                ...
                pump()
                driver.assert_complete()
                print("W101_CURRENT_IDENTITY=PASS")
            finally:
                window.destroy()
                pump()
