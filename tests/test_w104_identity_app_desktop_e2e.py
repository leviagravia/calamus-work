...
def load_app():
    ...
    name = "w104_identity_" + uuid.uuid4().hex
...
@unittest.skipUnless(RUN and HAVE_GTK and display_ready(), "real W104 GTK identity lane")
class W104IdentityRealAppE2E(unittest.TestCase):
        ...
        with tempfile.TemporaryDirectory() as temp:
            ...
            with patch.dict(os.environ, runtime_environment(paths), clear=False):
                ...
                try:
                    ...
                    print("W104_CURRENT_IDENTITY=PASS")
                finally:
                    window.destroy(); pump()
