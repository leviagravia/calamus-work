...
class ReleaseRegressionTests(unittest.TestCase):
    def test_expected_modules_are_present(self):
        ...
        expected = [
            ...
            "calamus_navigator_panel_view.py", "calamus_left_panel.py",
            "calamus_workspace.py", "calamus_workspace_controller.py",
    ...
    def test_research_shell_starts_registered_but_detached(self):
        ...
        self.assertNotIn("app.right_panel_host = right_panel_host", root)
        self.assertIn("self.right_panel_host = core_components.right_panel_host", source)
