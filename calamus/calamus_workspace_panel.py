...
class WorkspacePanelView:
    def __init__(
        ...
        *,
        ...
        for callback in (on_hide, on_choose_root, on_refresh, on_reveal, on_activate_item):
        ...
        self.hint = Gtk.Label(label="Open files here · double-click or Enter · read-only tree")
