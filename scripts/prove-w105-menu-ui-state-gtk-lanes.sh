...
cd "$ROOT"
python3 scripts/calamus-release-profiles.py --run-profile w105-identity-smoke
...
echo "W105_CURRENT_IDENTITY_TRUE_APP=PASS"
echo "W105_MENU_UI_STATE_TRUE_APP=PASS"
echo "W105_HISTORICAL_W104_COMMAND_ACTION=PASS"
echo "W105_HISTORICAL_W103_EDITOR_TRANSACTION=PASS"
echo "W105_HISTORICAL_W102_DOCUMENT_SESSION=PASS"
echo "W105_HISTORICAL_W101_COMPOSITION=PASS"
echo "W105_HISTORICAL_W99_LIFECYCLE=PASS"
echo "W105_HISTORICAL_W98_RESEARCH=PASS"
echo "W105_MENU_UI_STATE_GTK_LANES=PASS"
