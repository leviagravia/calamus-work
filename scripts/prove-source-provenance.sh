...
modules = [
    ...
    "calamus_workspace_host_runtime",
    "calamus_workspace_host_gtk",
    "calamus_clipboard_gtk",
    ...
    "calamus_state",
    "calamus_preferences",
    "calamus_application_state",
    "calamus_settings_repository",
    "calamus_preferences_controller",
    "calamus_persistent_collections",
    "calamus_preferences_composition",
    "calamus_menu_model",
    "calamus_ui_state",
    "calamus_ui_state_composition",
    "calamus_ui",
    "calamus_dialogs",
    "calamus_help",
    ...
    "calamus_search_runtime",
    "calamus_subsystem_composition",
    "calamus_spellcheck_runtime",
    "calamus_print_runtime",
    "calamus_clips",
    ...
    "calamus_research_application",
    "calamus_research_composition",
    "calamus_pandoc",
