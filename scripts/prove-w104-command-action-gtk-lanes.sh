...
cd "$ROOT"
python3 scripts/calamus-release-profiles.py --run-profile w104-identity-smoke
...
echo "W104_CURRENT_IDENTITY_TRUE_APP=PASS"
echo "W104_COMMAND_ACTION_TRUE_APP=PASS"
echo "W104_HISTORICAL_W103_EDITOR_TRANSACTION=PASS"
echo "W104_HISTORICAL_W102_DOCUMENT_SESSION=PASS"
echo "W104_HISTORICAL_W101_COMPOSITION=PASS"
echo "W104_HISTORICAL_W99_LIFECYCLE=PASS"
echo "W104_HISTORICAL_W98_RESEARCH=PASS"
echo "W104_COMMAND_ACTION_GTK_LANES=PASS"
